import{j as e}from"./index-CPA6k6Ej.js";import{H as n,F as a}from"./Footer-C14Ivnmf.js";const s=({children:t})=>e.jsxs("div",{className:"flex flex-col min-h-screen",children:[e.jsx(n,{}),e.jsx("main",{className:"flex-grow container mx-auto px-4 py-8",children:t}),e.jsx(a,{})]}),i=[{id:"1",title:"Первый пост в блоге о AI",slug:"first-ai-post",date:"2025-05-02",author:"Ontai AI Team",excerpt:"Это краткое описание первого поста в нашем новом блоге, посвященном искусственному интеллекту и его возможностям.",content:`
## Введение в мир AI
