        ...
        <section className="py-16 md:py-24 bg-gradient-to-b from-gray-50 to-white">
          <div className="container mx-auto px-4 md:px-6">
            <div className="text-center mb-12 md:mb-16">
              ...
              <p className="text-lg text-gray-600 md:max-w-2xl mx-auto">
                {t('pricing.subtitle')}
              </p>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
              {plans.map((plan) => (
                <div
                  key={plan.name}
                  className={`bg-white rounded-lg shadow-lg p-8 border ${plan.popular ? 'border-primary ring-2 ring-primary' : 'border-gray-200'}`}
                >
                  {plan.popular && (
